<nav class="nav">
    <div class="nav-inner">
        ...
        <div class="nav-links">
            ...
            <a href="{{ route('admin.rates.status') }}" @class(['active' => request()->routeIs('admin.rates.status')])>Scrape-status</a>
            <a href="{{ route('admin.settings.edit') }}" @class(['active' => request()->routeIs('admin.settings.*')])>Instellingen</a>
