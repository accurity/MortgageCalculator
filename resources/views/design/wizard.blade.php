...
@include('design.wizard.start')
@include('design.wizard.bedrag')
@include('design.wizard.huidig')
@include('design.wizard.periode')
@include('design.wizard.rente')
@include('design.wizard.vorm')
@include('design.wizard.io')
@include('design.wizard.inkomen')
@include('design.wizard.lasten')
